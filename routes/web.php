...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/order/new', [OrderClientController::class, 'show'])->name('order.client.show');
    ...
    Route::post('employee-call', [\App\Http\Controllers\EmployeeCallController::class, 'handle'])->name('employee.call');
